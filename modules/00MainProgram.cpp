...
long MainProgram::modelTimestepIter(long& VBA_dd) {
    ...
    obssolar = dataCells[rowD + dd][colD + dColD]; // observed total solar, horizontal, wm-2
    ...
    soilcalculator.get_soilwetness(drainage, runoff, waterold, x, thetafracres, thetafracfc, a, n, fieldcapfrac, thetafc, thetasat,
                                    water, depth, fc, ffc, dataCells, gs_ar_input, gs_ar_waterInitial_OFF, gs_ar_waterInitial, layerflow,
                                    baperga, lai, elayer, laisl, laish, timestep, soilredist, deficit, swclimit, tod, rain, waternew,
                                    waterchange, gs_ar_waterFinal, gwflow, transpirationtree, laperba, soilevap, gs_ar_E, gs_ar_ET, atree,
                                    gs_ar_Anet, gs_ar_cica, cinc, ca, gs_ar_cica_N, gs_ar_Aci, gs_ar_AnetDay, sum, kpday1, kxday1,
                                    gs_ar_waterInitial_GS, gs_ar_waterFinal_OFF, iter_refK, gs_ar_PLCSum, gs_ar_PLCSum_N, gs_ar_PLCp,
                                    gs_ar_PLC85, gs_ar_PLCx, gs_ar_waterInput_GS, gs_ar_waterFinal_GS, gs_ar_waterInput_OFF,
                                    layers, night,
                                    dd, gs_yearIndex, z, rowD, colD, dColF_End_watercontent, halt,  haltsh, iter_Counter, stage_ID, dColRain,
                                    layer, dColF_End_waterchange, dColF_End_rain, dColF_End_gwater, dColF_End_drainage, dColF_End_input,
