...
// Current developers: German Vargas G.
// Notes on additions:
// 1- Option to update atmospheric CO2 -> DONE
// 2- Weibull curve parameterization from p12 and p50 -> produces different results!!!!
//    2.a - Roots -> DONE
//    2.b - Stems -> DONE
//    2.c - Leaves -> DONE
// 3- Cavitation fatigue module
// 4- Easier to read parameter file - Will add 1 paramater at a time
//    4.a - I suspect problems are from the soil parameterization.
...
{
public:
   // variables added in v 1.2.5
   // Plant hydrodynamics
   //double rootP12, rootP50,stemP12, stemP50, leafP12, leafP50;// the model complains with this

   // variables in v 1.1.3
   ...
   bool locateRanges()
   {
      ...
      // option for predawns run
      if (getValueFromNameStr("i_predawnsMode") == "y")
      {
         mode_predawns = true;
   ...
   /* MODULE 2: Assigning-Cleaning variables */
   ...
   // weibull parameters
   double calculate_c(double px1, double px2, double x1 = 12, double x2 = 50) {
   ...
   double calculate_b(double px1, double c, double x1 = 12) {
      x1 /= 100; // proportion plc
      px1 *= -1;
